...
const STORAGE_KEY = 'kitsunebi.lang'
...
interface LanguageContextValue {
  ...
  /** Translate a UI key. */
  t: (key: UIKey) => string
  /** Pick the current language out of a localized value (e.g. card name). */
...
function initialLang(): Lang {
  ...
  return saved === 'be' || saved === 'en' ? saved : 'en'
}
